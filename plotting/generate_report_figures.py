...
def main() -> None:
	...
	original, fs = load_audio("../level_1/LicorDeCalandraca.wav")
	out1, fs1 = load_audio("../level_1/output_1.wav")
	out2, fs2 = load_audio("../level_2/output_2.wav")
	out3, fs3 = load_audio("../level_3/output_3.wav")
